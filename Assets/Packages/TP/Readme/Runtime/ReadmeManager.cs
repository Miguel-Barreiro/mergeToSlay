...
namespace MergeToStay.Packages.TP.Readme.Runtime
{
	...
	public class ReadmeManager : ISerializationCallbackReceiver
	{
		...
		public void OnBeforeSerialize() { objectIdPairs = null; }

		public void OnAfterDeserialize() { objectIdPairs = ObjectIdPairs; }
		...
		public static void AddObjectIdPair(Object obj, int objId)
		{
			...
			if (obj != null &&
				IdDict.TryGetValue(obj, out int foundId))
			{
				if (foundId != objId)
				{
		...
		private static void AddObjectIdPairToDicts(ObjectIdPair objectIdPair)
		{
			...
			if (objectIdPair.ObjectRef != null &&
				!IdDict.ContainsKey(objectIdPair.ObjectRef))
			{
