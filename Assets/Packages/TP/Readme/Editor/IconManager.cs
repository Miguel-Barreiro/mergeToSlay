...
namespace TP
{
	public class IconManager
	{
		...
		public static void SetIcon(GameObject gObj, Texture2D texture) { Internal_SetIcon(gObj, texture); }

		public static void RemoveIcon(GameObject gObj) { Internal_SetIcon(gObj, null); }
